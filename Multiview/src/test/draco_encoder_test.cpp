...
void Usage() 
{
	...
	printf("  -point_cloud          forces the input to be encoded as a point "
			"cloud.\n");
	printf("  -qp <value>           quantization bits for the position "
			"attribute, default=11.\n");
	printf("  -qt <value>           quantization bits for the texture coordinate "
			"attribute, default=10.\n");
	printf("  -qn <value>           quantization bits for the normal vector "
			"attribute, default=8.\n");
	printf("  -qg <value>           quantization bits for any generic attribute, "
			"default=8.\n");
	printf("  -cl <value>           compression level [0-10], most=10, least=0, "
			"default=7.\n");
...
/**
 * @brief 
 * USAGE: ./draco_encoder_test -point_cloud -i /home/lei/data/KinectStream/panoptic_captures/160317_moonbaby1_no_ground/ptcl/62.ply -o /home/lei/data/KinectStream/panoptic_captures/160317_moonbaby1_no_ground/ptcl/62.drc -cl 7
 * @param argc 
 * @param argv 
 * @return int 
 */
int main(int argc, char **argv) 
{
	...
	{
		std::cout << "Reading point cloud from file: " << options.input << std::endl;
	...
	if (poly_att_id != -1) 
		expert_encoder->SetAttributePredictionScheme(poly_att_id, draco::PredictionSchemeMethod::PREDICTION_NONE);
