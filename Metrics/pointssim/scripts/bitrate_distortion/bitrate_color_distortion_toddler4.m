...
for color_bitrate = 5000:5000:30000
    ...
    distorted_path = sprintf('%s/o3d_nvenc_c%dm_d_yuv130m_fps30_s_nocull_c_nocull/', base_path, color_bitrate_mbps);
    ...
    out_file_path = sprintf('%s/3D_c%dm_d_yuv130m_pssim.csv', comp_path, color_bitrate_mbps);
