...
for depth_bitrate = 20000:10000:130000
    ...
    % office1
    base_path = '/datassd/pipeline/client_tiled/pipeline_new/170915_office1_with_ground';
    start_frame = 0;
    end_frame = 2000;

    original_path = sprintf('%s/o3d_gt_with_ground_s_nocull_c_nocull/', base_path);
    distorted_path = sprintf('%s/o3d_nvenc_c100m_d_yuv%dm_fps30_s_nocull_c_nocull/log2/', base_path, depth_bitrate_mbps);
