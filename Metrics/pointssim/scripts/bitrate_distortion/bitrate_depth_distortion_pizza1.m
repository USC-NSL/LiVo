...
for depth_bitrate = 20000:10000:130000
    ...
    % pizza1
    base_path = '/datassd/pipeline/client_tiled/pipeline_new/160906_pizza1_with_ground';
    start_frame = 0;
    end_frame = 2000;

    original_path = sprintf('%s/o3d_gt_with_ground_s_nocull_c_nocull/log1/', base_path);
