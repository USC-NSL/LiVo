...
% bitrate_split_static('160906_band2_with_ground', 0, 5500, 1, 60000, '0.45')
% bitrate_split_static('170307_dance5_with_ground', 0, 10100, 0, 60000, '0.45')
% bitrate_split_static('170915_office1_with_ground', 0, 5900, 2, 60000, '0.45')
% bitrate_split_static('160906_band2_with_ground', 0, 5500, 1, 80000, '0.45')
% bitrate_split_static('160906_band2_with_ground', 0, 5500, 1, 100000, '0.45')
% bitrate_split_static('160906_band2_with_ground', 0, 5500, 1, 120000, '0.45')
% bitrate_split_static('160906_band2_with_ground', 0, 5500, 1, 160000)
% bitrate_split_static('160906_band2_with_ground', 0, 5500, 1, 200000)

function bitrate_split_static(seq_name, start_frame, end_frame, log_id, bitrate_kbps, d2c_split)
    ...
    distorted_path = sprintf('%s/bitrate_static_split_%s/%s/o3d_nvenc_%dk_fps30_%s/log%d/', base_path, d2c_split, seq_name, bitrate_kbps, culling, log_id);
    comp_path = sprintf('%s/bitrate_static_split_%s/%s/comp_o3d_pointssim_%s/log%d/', base_path, d2c_split, seq_name, culling, log_id);
