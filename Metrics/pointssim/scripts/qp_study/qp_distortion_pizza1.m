...
% taskset --cpu-list 12-15 matlab -nodisplay -nosplash -nodesktop -r "addpath(genpath('/home/lei/rajrup/KinectStream/Metrics/pointssim'));"
% qp_distortion_pizza1

%% Add path
logID = 1;
depth_qp = 0;
for color_qp = 0:10:51

    % pizza1
    base_path = '/datassd/pipeline_cpp/client_tiled/ablation/bitrate_study/160906_pizza1_with_ground';
