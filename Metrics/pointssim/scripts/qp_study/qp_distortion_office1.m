...
% taskset --cpu-list 8-11 matlab -nodisplay -nosplash -nodesktop -r "addpath(genpath('/home/lei/rajrup/KinectStream/Metrics/pointssim'));"
% qp_distortion_office1
...
for color_qp = 10:10:51
    ...
    % office1
    base_path = '/datassd/pipeline_cpp/client_tiled/ablation/bitrate_study/170915_office1_with_ground';
