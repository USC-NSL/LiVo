...
% taskset --cpu-list 4-7 matlab -nodisplay -nosplash -nodesktop -r "addpath(genpath('/home/lei/rajrup/KinectStream/Metrics/pointssim'));"
% qp_distortion_dance5
...
for color_qp = 10:10:51
    ...
    % dance5
    base_path = '/datassd/pipeline_cpp/client_tiled/ablation/bitrate_study/170307_dance5_with_ground';
    ...
    pssim_geomBA_list = [];
    pssim_colorBA_list = [];
    for frameID = start_frame:100:end_frame
