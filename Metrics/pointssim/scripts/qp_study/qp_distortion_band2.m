...
% taskset --cpu-list 0-3 matlab -nodisplay -nosplash -nodesktop -r "addpath(genpath('/home/lei/rajrup/KinectStream/Metrics/pointssim'));"
% qp_distortion_band2
...
for color_qp = 10:10:51
    ...
    % band2
    base_path = '/datassd/pipeline_cpp/client_tiled/ablation/bitrate_study/160906_band2_with_ground';
