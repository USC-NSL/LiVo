...
# END_FRAME=6193
FPS=30
# FPS=18              # 18 fps for d_bgra -> colorized depth
COLOR_BITRATE=20000
...
save_ptcl_path="/datassd/pipeline/client_tiled/ablation/$SEQ_NAME/o3d_nvenc_c${COLOR_BITRATE_M}m_d_bgra${DEPTH_BITRATE_M}m_s_pcull_c_cull/tracep1/"
render_image_path="/datassd/pipeline/client_tiled/ablation/$SEQ_NAME/o3d_nvenc_c${COLOR_BITRATE_M}m_d_bgra${DEPTH_BITRATE_M}m_s_pcull_c_cull/tracep1/"
# save_ptcl_path=""
# render_image_path=""
